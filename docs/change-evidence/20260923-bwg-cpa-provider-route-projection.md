...
The provider-to-alias mapping is maintained in `scripts/remote/cpa_provider_routes.json`.
...
- `pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/run_gates.ps1`: passed; 153 passed, 1 skipped, 179 subtests; Ruff, Bandit, and mypy passed.
