...
automatic fallback to relay-8003 or any other provider.
...
The relay-8003 route serves only `gpt-5.6-sol` and `gpt-5.6-terra`; it does not
serve Luna. The presence of `gpt-5.6-luna` in `/v1/models` proves catalog
