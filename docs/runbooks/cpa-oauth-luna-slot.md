...
The ai.input.im route serves `gpt-6-sol`, `gpt-6-astra`, `gpt-5.6-sol`, and
the optional `gpt-image-2.5` image route; it does not serve Luna. GPT-6 Sol is preconfigured but may not
